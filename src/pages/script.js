...
var uSpeed = 0.001; // sets rotation speed

//----------------------------------------------------------------- FOG background

var setcolor = 0xF02050; // Smoke color
...
var animate = function() {
  ...
  city.rotation.y -= ((mouse.x * 50) - camera.rotation.y) * uSpeed;
  city.rotation.x -= (-(mouse.y * 50) - camera.rotation.x) * uSpeed;
