...
const CreateItem = () => {
  ...
  const [formInput, updateFormInput] = useState({ price: '', name: '', description: '' ,auctionprice:''})
  ...
  async function uploadToIPFS() {
    const { name, description, price ,auctionprice} = formInput
    if (!name || !description || !price || !fileUrl || auctionprice) return
						...
						<div class="col-lg-6">
							<div class="left__part space-y-40 md:mb-20 upload_file">
								...
								<div class="space-y-20">
                                    ...
                                    className="inputfile" onChange={onChange} accept="image/*"/>
                                    ...
                                    { 
                                fileUrl &&  (
                                  <object className='asset-img' type="image/jpg" data={fileUrl}  />


                                        // <picture  >

                                        // <video className='asset-img' controls>
                                        // <source src={fileUrl} type="video/mp4"/>
                                        // </video>

                                        // <img className='asset-img' src={fileUrl} />
                                        // </picture>
                                    )
						...
						<div class="col-lg-6">
							<div class="form-group space-y-10">
								<div class="space-y-20">
									...
									{/* <div class="space-y-10">
										<span class="variationInput">AuctionPrice</span>
                                        <input class="form-select custom-select" id="dollerValue" placeholder="e. g. `20$`"
