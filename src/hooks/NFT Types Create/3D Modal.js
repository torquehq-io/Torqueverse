...
const Modal= () => {
	...
	const handleSubmit = (event) => {
	  ...
	  alert(`The name you entered was: ${link}`);
	};
								...
								<div class="space-y-20">
									...
									<div class="form-group space-y-10">
											...
											<input
								                ...
								                placeholder="input Model Link here"
											/>
											...
											<input class="btn btn-dark others_btn" type="submit" ></input>
											
										</form>

								
								
										<iframe className='asset-model ' controls autoplay src={link} />

									{/* <input name="Asset createinputfile"  id="createinputfile" type="link" 
                                    className="inputfile" onChange={onChange} /> */}
                                    ...
                                    {/* { 
                                fileUrl &&  (
                                  <iframe className='asset-img' type="link" src={fileUrl}  />
                                  
                                    
                                        <iframe className='asset-img' controls autoplay src={fileUrl}>

                                        </iframe>

                                        src='https://my.spline.design/cakeslicecopy-8a08408478d1adb48e27e04fb88de147/'
                                    )
